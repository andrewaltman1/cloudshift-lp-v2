    ...
    return (
        <>
            <Box key={"articles-small"} sx={{ color: '#272839', display: { xs: 'flex', md: 'none' }, flexFlow: 'column nowrap' }}>{articles.map((article) => <Box key={article.heading} sx={{
                ...
                <Box component="img" alt={article.altText} src={article.image} sx={{ width: '16.5rem', height: '11rem', borderRadius: '10px' }}></Box>
            </Box >
            )}
            </Box>
                ...
                <Container key={article.heading} >
                    <Box sx={{
                        ...
                        <Box sx={{ width: '40%', height: '90%', display: 'flex', flexFlow: 'column nowrap', justifyContent: 'space-evenly', alignItems: 'center' }}>
                            ...
                            <Box component="img" alt={article.altText} src={article.image} sx={{ width: '16.5rem', height: '11rem', borderRadius: '10px', boxShadow: '0px 0px 10px 0px #2278ab44' }}>
                            </Box>
                        </Box>
